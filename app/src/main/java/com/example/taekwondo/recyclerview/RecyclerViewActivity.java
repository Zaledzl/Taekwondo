...
import com.example.taekwondo.GridRecyclerViewActivity;
import com.example.taekwondo.R;

public class RecyclerViewActivity extends AppCompatActivity {

    private Button mBtnLinear,mBtnHor,mBtmGrid,mBtnPu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtmGrid = findViewById(R.id.btn_grid);
        ...
        mBtmGrid.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
